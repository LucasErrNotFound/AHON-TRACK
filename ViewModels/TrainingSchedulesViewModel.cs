    ...
    private List<ScheduledPerson> CreateSampleData()
    {
        ...
        [
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(9), ScheduledTimeEnd = DateTime.Today.AddHours(12), Attendance = null
            },
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(8), ScheduledTimeEnd = DateTime.Today.AddHours(11), Attendance = null
            },
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(14), ScheduledTimeEnd = DateTime.Today.AddHours(16),  Attendance = null
            },
            new ScheduledPerson
            {
            ...
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(17), ScheduledTimeEnd = DateTime.Today.AddHours(18), Attendance = null
            },
            new ScheduledPerson
            {
            ...
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(19), ScheduledTimeEnd = DateTime.Today.AddHours(20),  Attendance = null
            },
            new ScheduledPerson
            {
            ...
            new ScheduledPerson
            {
                ...
                ScheduledTimeStart = DateTime.Today.AddHours(21), ScheduledTimeEnd = DateTime.Today.AddHours(22), Attendance = null
            }
        ];
    }
